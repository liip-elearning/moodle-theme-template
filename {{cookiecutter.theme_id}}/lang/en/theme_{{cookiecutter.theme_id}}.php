...
/**
 * {{cookiecutter.theme_name}} theme language file.
 *
...
$string['choosereadme'] = 'Theme {{cookiecutter.theme_name}} is a child theme of Boost. It adds the ability to upload background photos.';
// Name of the settings pages.
$string['configtitle'] = '{{cookiecutter.theme_name}} settings';
...
$string['pluginname'] = '{{cookiecutter.theme_name}}';
